...
export interface CreateCatalogItemDialogProps {
  open: boolean;
  onClose: () => void;
...
export const CreateCatalogItemDialog = ( props: CreateCatalogItemDialogProps ): ReactElement => {
  ...
  const vendor = useWatch<Vendor|null>( {
    name: 'vendor',
    control,
  } );
  ...
  const vendorId = props.vendorId || vendor?.id;
  ...
  const handleConfirm = async ( ) => {
    ...
    data.packs.push( { vendorId, ...formValues } )
